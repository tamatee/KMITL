...
public class easyMemoryGame extends JFrame implements ActionListener, WindowListener {
    ...
    public easyMemoryGame() {
        setTitle("Memory Game");
        setSize(600, 600);
        setResizable(false);
        setDefaultCloseOperation(easyMemoryGame.DISPOSE_ON_CLOSE);
        ...
        timeLabel = new JLabel("Time left: 0:45");
        ...
        for (int i = 0; i < images.length; i++) {
            tmpImage = new ImageIcon(getClass().getResource("image" + i + ".jpg"));
        ...
        clock = new Timer(1000, new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (timeLeft == 0) {
                    clock.stop();
                    JOptionPane.showMessageDialog(easyMemoryGame.this, "Time's up! You lose.");
                }
            }
        });
        clock.start();
    ...
    private void restartGame() {
        ...
        score = 0;
        scoreLabel.setText("Score: " + score);
        timeLabel.setText("Time left: 0:45");
        pairSuc.clear();
        clock.restart();
    }
